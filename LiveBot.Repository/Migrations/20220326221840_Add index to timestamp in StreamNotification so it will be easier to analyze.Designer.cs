...
namespace LiveBot.Repository.Migrations
{
    ...
    [Migration("20220326221840_Add index to timestamp in StreamNotification so it will be easier to analyze")]
    partial class AddindextotimestampinStreamNotificationsoitwillbeeasiertoanalyze
    {
